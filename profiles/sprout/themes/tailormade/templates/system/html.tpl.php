...
<head>
  ...
  <link rel="apple-touch-icon-precomposed" href="/<?php print drupal_get_path('theme', 'tailormade'); ?>/images/apple-touch-icon-76x76-precomposed.png">
  <link rel="apple-touch-icon-precomposed" sizes="76x76" href="/<?php print drupal_get_path('theme', 'tailormade'); ?>/images/apple-touch-icon-76x76-precomposed.png">
  <link rel="apple-touch-icon-precomposed" sizes="120x120" href="/<?php print drupal_get_path('theme', 'tailormade'); ?>/images/apple-touch-icon-120x120-precomposed.png">
  <link rel="apple-touch-icon-precomposed" sizes="152x152" href="/<?php print drupal_get_path('theme', 'tailormade'); ?>/images/apple-touch-icon-152x152-precomposed.png">
  <link rel="apple-touch-icon-precomposed" sizes="180x180" href="/<?php print drupal_get_path('theme', 'tailormade'); ?>/images/apple-touch-icon-180x180-precomposed.png">
  <link rel="icon" sizes="192x192" href="/<?php print drupal_get_path('theme', 'tailormade'); ?>/images/apple-touch-icon-180x180-precomposed.png">
  <!-- uncomment below to use Google fonts -->
  <!-- use %7C instead of the | character for HTML validation purposes -->
  <link href="http://fonts.googleapis.com/css?family=Source+Sans+Pro:400italic,600italic,700italic,400,600,700" rel="stylesheet" type="text/css">
  <?php print $styles; ?>
  <?php print $scripts; ?>
</head>
