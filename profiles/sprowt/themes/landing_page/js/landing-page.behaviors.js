(function ($) {
   ...
   */
  Drupal.theme.prototype.landingPageExampleButton = function (path, title) {
   ...
   */
  Drupal.behaviors.landingPageExampleBehavior = {
    attach: function (context, settings) {
      ...
      $('.some-selector', context).once('foo', function () {
        ...
        var $anchor = Drupal.theme('landingPageExampleButton', settings.myExampleLinkPath, settings.myExampleLinkTitle);
