(function ($) {
  ...
  Drupal.behaviors.sprowtMenu = {
    attach: function (context, settings) {
      ...
      $('#block-logo-block-logo').once().append('<div class="mobile-menu-toggle"><span>Menu</span><i class="fa fa-bars"></i></div><div class="tablet-menu-toggle"><i class="fa fa-bars"></i><span>Menu</span></div>');
