...
<head>
  ...
  <link rel="apple-touch-icon-precomposed" href="/<?php print drupal_get_path('theme', 'mcmpest'); ?>/images/apple-touch-icon-76x76-precomposed.png">
  <link rel="apple-touch-icon-precomposed" sizes="76x76" href="/<?php print drupal_get_path('theme', 'mcmpest'); ?>/images/apple-touch-icon-76x76-precomposed.png">
  <link rel="apple-touch-icon-precomposed" sizes="120x120" href="/<?php print drupal_get_path('theme', 'mcmpest'); ?>/images/apple-touch-icon-120x120-precomposed.png">
  <link rel="apple-touch-icon-precomposed" sizes="152x152" href="/<?php print drupal_get_path('theme', 'mcmpest'); ?>/images/apple-touch-icon-152x152-precomposed.png">
  <link rel="apple-touch-icon-precomposed" sizes="180x180" href="/<?php print drupal_get_path('theme', 'mcmpest'); ?>/images/apple-touch-icon-180x180-precomposed.png">
  <link rel="icon" sizes="192x192" href="/<?php print drupal_get_path('theme', 'mcmpest'); ?>/images/touch-icon-180x180.png">
